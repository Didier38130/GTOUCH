...
<body>
  <nav id="header_compte_client">
    <ul>
      <li><a href="../controler/compte_client_commandes.controler.php" class="commandes">Mes Commandes</a></li>
      <li><a href="../controler/choixGraphisteCommande.controler.php">Mon graphiste</a></li>
