...
//si c'est un client alors on récupère les données de celui correspondant à l'e-mail et on utilise le header client
  if ($q1 && !$q2) {
    ...
    //si c'est un graphiste alors on récupère les données de celui correspondant à l'e-mail et on utilise le header graphiste
  }else{
