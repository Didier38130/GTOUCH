...
insert into servicesdispo values(4, "Lumière", "Ambiance", "Retouche paysage", "Arranger l'éclairages");
insert into servicesdispo values(5, "Couleur", "Ambiance", "Retouche paysage", "Faire ressortir les couleurs");

insert into servicesdispo values(6, "Forme", "Corps", "Retouche beauté", "Corriger les formes du corps");
insert into servicesdispo values(7, "Silhouette", "Corps", "Retouche beauté", "Améliorer la silhouette");

insert into servicesdispo values(8, "Regard", "Visage", "Retouche beauté", "Adoucir le regard");
